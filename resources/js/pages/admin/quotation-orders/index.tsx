                    ...
                    <table className="w-full">
                        <thead>
                            <tr className="border-b bg-gray-50">
                                ...
                                <th className="px-6 py-3 text-center text-sm font-semibold text-gray-900">Unidad de negocio</th>
                            ...
                            {quotationOrders.length > 0 ? (
                                quotationOrders.map((order) => (
                                    <tr
                                        ...
                                        onClick={() => (window.location.href = route('dashboard.quotation-orders.show', order.id))}
                                    >
