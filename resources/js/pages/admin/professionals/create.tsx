            ...
            <div className="mx-auto mt-2 w-full min-w-0 max-w-4xl sm:mt-6">
                <div className="mb-6 flex flex-col gap-3 sm:mb-8 sm:flex-row sm:items-center">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-sm text-slate-600">El nombre y el resumen solo los verá el administrador; el cliente verá Profesional #ID y los años de experiencia.</p>
                    </div>
                </div>
