            ...
            <div className="w-full min-w-0 space-y-4">
                <div className="mx-auto flex w-full min-w-0 max-w-6xl flex-col items-stretch gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div className="flex items-center gap-3">
                        <BriefcaseBusiness className="h-7 w-7 shrink-0 text-blue-600 sm:h-8 sm:w-8" />
                        <div className="min-w-0 text-left">
                            <h1 className="text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl">Unidades de negocio</h1>
                        ...
                        <tbody className="divide-y divide-gray-100 bg-white">
                            {rows.length > 0 ? (
                                rows.map((unit) => (
                                    ...
                                    >
                                        <td className="px-3 py-3 text-sm text-gray-900 sm:px-6 sm:py-4">{unit.id}</td>
                                        <td className="px-3 py-3 text-sm font-medium text-gray-900 sm:px-6 sm:py-4">{capitalize(unit.display_name)}</td>
